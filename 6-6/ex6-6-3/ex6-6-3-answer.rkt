...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex6-6-3-answer) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")) #f)))
;; teachpack: draw.ss
;; DATA DEFINITION
...
;; the poinr (1,5) is outside the circle located at (6,5) with radius 1
